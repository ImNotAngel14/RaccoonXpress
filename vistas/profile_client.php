        ...
        <form id="profile_form" enctype="multipart/form-data" method="post" onsubmit="return validate()">
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="id_username" name="username" placeholder="Nombre de usuario">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="id_email" name="email" placeholder="Correo electrónico">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="id_password" name="password" placeholder="Contraseña">
                </div>
                ...
                <!--div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="id_confirm_password" name="confirm_password" placeholder="Confirmar contraseña">
                </div-->
